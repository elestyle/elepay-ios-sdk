...
- (void)makePayPalWithToken:(NSString *)token payment:(NSString *)amount currencyCode:(NSString *)currency callback:(void(^)(NSString * _Nullable nonce, NSError * _Nullable error))onResult;
