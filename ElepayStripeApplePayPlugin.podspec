Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/elestyle/elepay-ios-sdk/releases/download/5.0.5/ElepayStripeApplePayPlugin-pods.xcframework.zip", :sha256 => "accb1d6172533a01ffc818cf511db7fe2e358fc9431a61f12cc8c6d2410eaaf1" }
